...
if __name__ == "__main__":
    ...
    print("[.] You can query 4 times, and it will propose you to modify one line of encryption or decryption module every time")
    print("[.] Format concerning line modification is [line]:[variable]")
    print("[.] For example 2:p will add 'p = random.randint(3,2**512)' before 'n = p*q' in decryption processif you're in decryption module")
    ...
    m = int(binascii.hexlify("Bravo tu as trouve le message ! Le mot de passe est Gat0rgokuB1sk"),16)
    n = key[0]
    exec(encrypt_str)
    print("c = "+str(c))
